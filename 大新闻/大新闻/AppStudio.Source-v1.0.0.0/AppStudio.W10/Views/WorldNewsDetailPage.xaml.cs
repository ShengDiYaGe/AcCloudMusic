//---------------------------------------------------------------------------
//
// <copyright file="WorldNewsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class WorldNewsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public WorldNewsDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new WorldNewsConfig());
