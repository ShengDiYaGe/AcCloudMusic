...
namespace AppStudio.ViewModels
{
    public class MainViewModel : PageViewModel
    {
        ...
        {
            PageTitle = "搞大新闻";
            WorldNews = new ListViewModel<RssDataConfig, RssSchema>(new WorldNewsConfig(), visibleItems);
            ChinaNews = new ListViewModel<RssDataConfig, RssSchema>(new ChinaNewsConfig(), visibleItems);
        ...
        public ListViewModel<RssDataConfig, RssSchema> WorldNews { get; private set; }
        public ListViewModel<RssDataConfig, RssSchema> ChinaNews { get; private set; }
        ...
        {
            yield return WorldNews;
            yield return ChinaNews;
        }
    }
}
